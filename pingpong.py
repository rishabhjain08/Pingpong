...
WALL_FORCE = 4000000        # ACCELERATION PER MOVE
...
def build_graph():
    ...
    root.title('Balls')
    left = (root.winfo_screenwidth() - WIDTH) / 2                          # winfo_screenwidth gives the width of the screen in pixels
    top = (root.winfo_screenheight() - HEIGHT) / 2                         # winfo_screenheight gives the height of the screen in pixels
